class TinyTown extends Phaser.Scene {
    ...
    create() {
        ...
        this.toolLayer = this.map.createLayer("Tools-n-Stuff", this.tileset, 0, 0);
        this.grassLayer.setScale(4.0);
        this.treeLayer.setScale(4.0);
        this.toolLayer.setScale(4.0);

        document.getElementById('description').innerHTML = '<h2>Welcome to Luborg.</h2>'
    }
